...
const components: ComponentProps<typeof ReactMarkdown>['components'] = {
  ...
  sup: SupRenderer,
  code: CodeRenderer,
  h1: ({ children }) => <h1 className='my-4 text-3xl font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h1>,
  h2: ({ children }) => <h2 className='my-3 text-2xl font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h2>,
  h3: ({ children }) => <h3 className='my-2 text-xl font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h3>,
  h4: ({ children }) => <h4 className='my-2 text-lg font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h4>,
  h5: ({ children }) => <h5 className='my-1 text-base font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h5>,
  h6: ({ children }) => <h6 className='my-1 text-sm font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</h6>,
  strong: ({ children }) => <strong className='font-bold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</strong>,
  ...
  th: ({ children }) => <th className='border border-gray-300 px-4 py-2 font-semibold font-[Georgia,"Noto_Sans_JP",sans-serif]'>{children}</th>,
