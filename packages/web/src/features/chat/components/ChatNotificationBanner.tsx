      ...
      <NotificationBannerBody>
        <div className='flex flex-col gap-4'>
          ...
          <dl className='flex flex-col gap-4'>
            <div>
              <dt className='mb-2 font-bold font-["Noto_Sans_JP",sans-serif]'>リスクの例：</dt>
              <dd>
                <Ul>
            ...
            <div>
              <dt className='mb-2 font-bold font-["Noto_Sans_JP",sans-serif]'>対応アクション：</dt>
              <dd>
                <Ol>
                  <li>
            ...
            <div>
              <dt className='mb-2 font-bold font-["Noto_Sans_JP",sans-serif]'>
